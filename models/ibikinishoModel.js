...
const ibikinishoSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
ibikinishoSchema.pre('save', function (next) {
...
const Ibikinisho = mongoose.model('Ibikinisho', ibikinishoSchema);

module.exports = Ibikinisho;
