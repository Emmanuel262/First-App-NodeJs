...
const abikoreraSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
abikoreraSchema.pre('save', function (next) {
...
const Abikorera = mongoose.model('Abikorera', abikoreraSchema);

module.exports = Abikorera;
