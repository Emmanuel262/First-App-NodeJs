...
router
  .route('/everyone')
  .get(adminFactory.renderNewAll)
  .post(
    upload.array('image', 5),
    adminFactory.createData,
    saveDataAndRedirectAll('newForAll')
  );
...
router.post(
  ...
  upload.array('image', 5),
  adminFactory.createData,
  saveDataAndRedirectAll('new')
);
router.put('/amazu/:id', upload.array('image', 5), adminFactory.updateData);
router.delete('/amazu/:id', adminFactory.deleteData);
// Admin for ibibanza
router.put('/ibibanza/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for imirima
router.put('/imirima/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for inzuri
router.put('/inzuri/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for imodoka
router.put('/imodoka/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for moto
router.put('/moto/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for apartment
router.put('/apartment/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for rooms
router.put('/rooms/:id', upload.array('image', 5), adminFactory.updateData);
...
router.put('/imirimag/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for imodokag
router.put('/imodokag/:id', upload.array('image', 5), adminFactory.updateData);
...
router.put('/motog/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Amashuri
router.put('/inshuke/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Amashuri
router.put('/abanza/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Amashuri
router.put('/kaminuza/:id', upload.array('image', 5), adminFactory.updateData);
...
router.put('/amazuk/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Kwigurishiriza
router.put('/ibibanzak/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Kwigurishiriza
router.put('/imirimak/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Kwigurishiriza
router.put('/inzurik/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Kwigurishiriza
router.put('/imodokak/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Kwigurishiriza
router.put('/motok/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Imyidagaduro
router.put('/ubugeni/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Imyidagaduro
router.put('/imikino/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Imyidagaduro
router.put('/muzika/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Imyidagaduro
router.put('/abana/:id', upload.array('image', 5), adminFactory.updateData);
...
router.put('/artists/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for made in rwanda
router.put('/imyambaro/:id', upload.array('image', 5), adminFactory.updateData);
...
router.put('/arangisha/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Amatangazo
router.put('/ahindura/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Amatangazo
router.put('/amenyesha/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Akazi
router.put('/kuranga/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Akazi
router.put('/gusaba/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Impuguke
router.put('/impuguke/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Impuguke
router.put('/impugukek/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Transport
router.put('/amakamyo/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Transport
router.put('/bus/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Transport
router.put('/motot/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Transport
router.put('/fuso/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Transport
router.put('/daihatsu/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Inkunga
router.put('/ngo/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Inkunga
router.put('/abikorera/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Inkunga
router.put('/amabanki/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Isoko
router.put('/ubuconco/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Isoko
router.put('/ibiribwa/:id', upload.array('image', 5), adminFactory.updateData);
...
// Admin for Isoko
router.put('/amatungo/:id', upload.array('image', 5), adminFactory.updateData);
...
function saveDataAndRedirectAll(path) {
