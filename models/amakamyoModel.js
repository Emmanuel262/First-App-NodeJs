...
const amakamyoSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
amakamyoSchema.pre('save', function (next) {
...
const Amakamyo = mongoose.model('Amakamyo', amakamyoSchema);

module.exports = Amakamyo;
