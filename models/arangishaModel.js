...
const arangishaSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
arangishaSchema.pre('save', function (next) {
...
const Arangisha = mongoose.model('Arangisha', arangishaSchema);

module.exports = Arangisha;
