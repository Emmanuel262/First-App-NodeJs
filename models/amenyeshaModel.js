...
const amenyeshaSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
amenyeshaSchema.pre('save', function (next) {
...
const Amenyesha = mongoose.model('Amenyesha', amenyeshaSchema);

module.exports = Amenyesha;
