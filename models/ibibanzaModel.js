...
const ibibanzaSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
ibibanzaSchema.pre('save', function (next) {
...
const Ibibanza = mongoose.model('Ibibanza', ibibanzaSchema);

module.exports = Ibibanza;
