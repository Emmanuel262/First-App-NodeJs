...
const imyambaroSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
imyambaroSchema.pre('save', function (next) {
...
const Imyambaro = mongoose.model('Imyambaro', imyambaroSchema);

module.exports = Imyambaro;
