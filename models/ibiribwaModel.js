...
const ibiribwaSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
ibiribwaSchema.pre('save', function (next) {
...
const Ibiribwa = mongoose.model('Ibiribwa', ibiribwaSchema);

module.exports = Ibiribwa;
