...
const amashyambaSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
amashyambaSchema.pre('save', function (next) {
...
const Amashyamba = mongoose.model('Amashyamba', amashyambaSchema);

module.exports = Amashyamba;
