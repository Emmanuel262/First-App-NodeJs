...
const amatungoSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
amatungoSchema.pre('save', function (next) {
...
const Amatungo = mongoose.model('Amatungo', amatungoSchema);

module.exports = Amatungo;
