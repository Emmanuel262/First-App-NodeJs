...
const ubuconcoSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
ubuconcoSchema.pre('save', function (next) {
...
const Ubuconco = mongoose.model('Ubuconco', ubuconcoSchema);

module.exports = Ubuconco;
