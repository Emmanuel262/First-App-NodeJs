...
const taxVoitureSchema = new mongoose.Schema(
  {
    name: {
      type: String,
...
taxVoitureSchema.pre('save', function (next) {
...
const TaxVoiture = mongoose.model('TaxVoiture', taxVoitureSchema);

module.exports = TaxVoiture;
