...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia29lc3RuZXIiLCJhIjoiY2tkenR4bXRjMzlkcTJzb2RpcG10ZWRmdyJ9.Pa9fpB0GL71C9ZBTUMjurg';
...
exports.updateDataNeeded = exports.updateSettings = void 0;
...
var updateDataNeeded = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/amazu/".concat(id),
              data: data
            });
  ...
  return function updateDataNeeded(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateDataNeeded = updateDataNeeded;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"insertData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteData = exports.insertData = void 0;
...
var insertData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, summary, description, imageCover, images, cost, locations, nationality, vieoLink) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function insertData(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', _context2.t0.response.data.messasge);
  ...
  return function deleteData(_x10) {
    return _ref2.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51HIIolLaUVzEhIizFcI7jckCtdDRRFMaodzvyOleMQmgIkkBVRQDXIZzwftRLBBj5gytIgwX8Ej2x0um3Y0NVrUs00ir2Nylro');
...
var insertDatas = document.querySelector('.insert-data');
var deleteBtn = document.querySelector('.siba-data');
var editBtn = document.querySelector('.edit-data'); // VALUES
// DELEGATION
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // if (deleteBtn) {
...
if (insertDatas) {
  insertDatas.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name').value;
    ...
    (0, _insertData.insertData)(name, summary, description, imageCover, images, cost, locations, Nationality, videolink);
