...
// router.get(
//   '/ihaho/test-amazu-crud',
//   //   authController.isLoggedIn,
//   viewsController.getAmazuTest
// );
// router.get(
//   '/ihaho/test-amazu-crud/list',
//     authController.isLoggedIn,
//   viewsController.getAmazuList
// );
// *******************
//****************** */
// router.delete('/ihaho/test-amazu-crud/delete/:id', viewsController.deleteList);
// router.post('/ihaho/test-amazu-crud/:id', viewsController.updateRecord);
// router.get('/ihaho/test-amazu-crud/delete/:id', viewsController.deleteList);
// router.get('/ihaho/test-amazu-crud/:id', viewsController.updateRecord);

// router.get('/ihaho-amazu-detail', amazuController.goGetForm);
// router.post('/ihaho-amazu-detail', amazuController.updateData);
// router.get('/ihaho-amazu-detail/list', amazuController.getList);
// router.get('/ihaho-amazu-detail/:id', amazuController.updateOneData);
// router.get('/ihaho-amazu-detail/delete/:id', amazuController.deleteOneData);
